...
# sql connector
connection = pymysql.connect(host='sql12.freemysqlhosting.net',user='sql12723431',password='8tXfpf1Y6K')
...
def run():
    ...
    st.sidebar.title("ResumeX : Unlock Your Next Opportunity")
    st.logo("./Logo/resume_x.jpeg", icon_image="./Logo/resume_x.jpeg")
    with st.sidebar.container(): 
        st.image('./Logo/resume_x.jpeg', use_column_width=True, caption='ResumeX : Unlock Your Next Opportunity')
...
Join the ResumeX community today and take the next step towards your dream job!
    ...
    st.sidebar.markdown('''
        ...
        <div id="sfcb2j4e593kabemp2m8eww4c4m63e339lu" hidden></div>

        <noscript>
            <a href="https://www.freecounterstat.com" title="hit counter">
                <img src="https://counter8.optistats.ovh/private/freecounterstat.php?c=b2j4e593kabemp2m8eww4c4m63e339lu" border="0" title="hit counter" alt="hit counter"> -->
            </a>
        </noscript>
    ...
    # Create the DB
    db_sql = """CREATE DATABASE IF NOT EXISTS sql12723431;"""
    cursor.execute(db_sql)
    cursor.execute("USE sql12723431")
